	...
	class TGM_Plugin_Activation {
		...
		public function __construct() {
			...
			$this->strings = array(
				...
				'notice_can_activate_required'    => _n_noop( 'The following required plugin is currently inacktive: %1$s.', 'The following required plugins are currently inacktive: %1$s.' ),
				'notice_can_activate_recommended' => _n_noop( 'The following recommended plugin is currently inacktive: %1$s.', 'The following recommended plugins are currently inacktive: %1$s.' ),
		...
		public function notices() {
			...
			foreach ( $this->plugins as $plugin ) {
				...
				elseif ( is_plugin_inacktive( $plugin['file_path'] ) ) {
		...
		public function force_activation() {
			...
			foreach ( $this->plugins as $plugin ) {
				...
				elseif ( isset( $plugin['force_activation'] ) && $plugin['force_activation'] && is_plugin_inacktive( $plugin['file_path'] ) )
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		public function column_plugin( $item ) {
			...
			elseif ( is_plugin_inacktive( $item['file_path'] ) ) {
				$actions = array(
					'activate' => sprintf(
